          ...
          <div class="row">
              ...
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Clube de Campo - Conteúdo</h3>                                    
                </div><!-- /.box-header -->
                <div class="box-body table-responsive">
                  <form id="formDataClubeDeCampo" class="col s12" action="lazerSendData.php" method="POST" enctype="multipart/form-data">
										<div class="row">
												<?php
                            $sql = "SELECT * FROM `app_lazer` WHERE `categoria` = 'clubeDeCampo'";
                        ...
                        <div class="row">  
                            ...
                            <textarea rows="3" cols="3" required class="form-control" id="gmaps_link" name="gmaps_link" value="<?php echo $row["gmaps_link"] ?>"><?php echo $row["gmaps_link"] ?></textarea>
													...
													<div class="form-group col-xs-12 col-sm-3">
														...
														<img src="/app-data/api/img/clubeDeCampo/img_cover.jpg" alt="Imagem de capa atual" title="Imagem de capa atual" style="max-width: 100%;">
													</div>
													<div class="form-group col-xs-12 col-sm-3">
                  ...
                  <div class="box-header">
                    <a href="<?php echo $baseUrl ?>/pages/tabela/clubeDeCampo-fotos.php" class="btn btn-success" style="color: #fff;">Gerenciar fotos</a>                                    
                  </div><!-- /.box-header -->
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div>
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Clube de Campo - Tabela de Preços </h3>                                    
                </div><!-- /.box-header -->
                <div class="box-body table-responsive">
                  <form action="preencheClubeDeCampo.php" method="POST" id="formClubeDeCampo" class="col s12">
                    <table class="table table-bordered table-hover" style="margin-bottom: 50px">
                        <thead>
                            <tr><th colspan="2">Associados/Dependentes</th></tr>
                        </thead>
                        <tbody>
                        <?php
                            $sql = "SELECT * FROM `app_clubedecampotable` WHERE `tipo` = 1";
                            $result = mysqli_query($conexao, $sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>R$ <input type="text" class="money" name="<?php echo $row["id"] ?>" value="<?php echo realBR($row["valor"])?>"></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
                    <table class="table table-bordered table-hover" style="margin-bottom: 50px">
                        <thead>
                            <tr>
                                <th colspan="2">Convidados</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                $sql = "SELECT * FROM `app_clubedecampotable` WHERE `tipo` = 2";
                                $result = mysqli_query($conexao, $sql);
                    ...
                    <table class="table table-bordered table-hover" style="margin-bottom: 50px">
                        <thead>
                            <tr>
                                <th colspan="2">Convidados para passar o dia no Clube</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
                            $sql = "SELECT * FROM `app_clubedecampotable` WHERE `tipo` = 3";
                            $result = mysqli_query($conexao, $sql);
