    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
      ...
      <aside class="right-side">
        ...
        <section class="content-header">
            <h1>Colônia de Férias- Galeria</h1>
        </section>
                  ...
                  <form method="POST" action="postGalleryPhotos.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6">
                        ...
                        <small>Largura recomendada: 320px</small>
                      </div>
                    </div>
                    <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  <div class="row">
                  <?php
                        $sql = "SELECT * FROM `app_lazer_gallery` WHERE `categoria` = 'coloniaDeFerias' ORDER BY `id` asc";
                  ...
                  <form action="enviaFoto.php" method="POST" id="formColoniaDeFerias" class="col s12">
                    <div class="row">
                      <div class="col-xs-12 text-right">
                        <button class="btn btn-success">Enviar</button>
                      </div>
